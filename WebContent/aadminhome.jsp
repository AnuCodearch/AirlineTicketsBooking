...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/aero2.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <center>
	<br><br><br><br><br><br>
	<!-- <a href="aadminhome.jsp">HOME</a> -->
	<a href="aviewusers.jsp" class="btn btn-md col-lg-4" style="background-color:white">VIEW USERS</a><br><br>
	<a href="aaddflight.jsp" class="btn btn-md col-lg-4"  style="background-color:white">ADD FLIGHT</a><br><br>
	<a href="asendmsg.jsp" class="btn btn-md col-lg-4"  style="background-color:white">SEND MESSAGE</a><br><br>
	<a href="abooked.jsp" class="btn btn-md col-lg-4"  style="background-color:white">BOOKED TICKETS</a><br><br>
	</center>
	<br><br><br><br><br><br>
          </div>
        </div>
...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="css/bootstrap-datepicker.css">
    <link srel="stylesheet" href="css/jquery.timepicker.css">
...
<body>
<div class="hero-wrap js-fullheight" style="background-image: url('images/aero1.jpg');">
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">Airplanes</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	...
	<br><br><br><br>
			<div class="col-lg-12">
				<br><br><br>
				<form action="aRegisterservlet" method="post" class="col-lg-3">
					...
					<input type="submit" value="Login" name="submit" class="btn btn-danger btn-lg btn-block"/></a>
					<br>
					<h6 style="color:white;">Not yet registered? <a href="aregister.jsp">Register</a></h6>
					<br>
				</form>
			</div>
			<br>
...
<body>
<div style="background-image: url('images/aero2.jpg');background-repeat:no-repeat;">
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">Airplanes</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" ><a href="aadminhome.jsp" class="nav-link" style="color:black"><b>HOME</b></a></li>
	...
	<br><br><br><br><br><br>
	<!-- <a href="aadminhome.jsp">HOME</a> -->
	<a href="aviewusers.jsp" class="col-lg-2" style="background-color:white">VIEW USERS</a><br><br>
	<a href="aaddflight.jsp" class="col-lg-2" style="background-color:white">ADD FLIGHT</a><br><br>
	<a href="asendmsg.jsp" class="col-lg-2" style="background-color:white">SEND MESSAGE</a><br><br>
	<a href="alogout.jsp" class="col-lg-2" style="background-color:white">LOGOUT</a><br><br>
	</center>
	<br><br><br><br><br><br>
</body>
</html>            --%>