...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="#">Airplanes</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="auserlogin.jsp" class="nav-link">USER</a></li>
	...
	<div class="hero-wrap js-fullheight" style="background-image: url('images/source.gif');">
 <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>We <br></strong>help you fly </h1>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Explore your amazing city</p>
            <div class="block-17 my-4">
              <form action="" method="post" class="d-block d-flex">
                ...
                <a href="auserlogin.jsp">
                <input type="submit" class="search-submit btn btn-primary" value="Search" style="margin-left:450px;margin-top:1px;"> 
                </a> 
              </form>
            </div>
            ...
            <p class="browse d-md-flex">
            	...
            	<span class="d-flex justify-content-md-center
            	 align-items-md-center"><a href="#"><i class="flaticon-hotel"></i>Hotel</a></span> 
